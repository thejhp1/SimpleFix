        ...
        <div className='update-modal-outer-container'>
          <div className='create-part-modal-inner-container'>
            ...
            <div className='update-modal-input'>
              ...
              {errors.ticketNumber && <p className="create-part-modal-error-ticketNumber"><i className="fa-solid fa-circle-exclamation"></i> {errors.ticketNumber}</p>}
              <input className={`${errors.partNumber ? "update-modal-error" : ""}`} value={partNumber} onChange={(e) => setPartNumber(e.target.value)}></input>
              {errors.partNumber && <p className="create-part-modal-error-partNumber"><i className="fa-solid fa-circle-exclamation"></i> {errors.partNumber}</p>}
              <input className={`${errors.description ? "update-modal-error" : ""}`} value={description} onChange={(e) => setDescription(e.target.value)}></input>
              {errors.description && <p className="create-part-modal-error-description"><i className="fa-solid fa-circle-exclamation"></i> {errors.description}</p>}
              <input className={`${errors.price ? "update-modal-error" : ""}`} value={price} onChange={(e) => setPrice(e.target.value)}></input>
              {errors.price && <p className="create-part-modal-error-price"><i className="fa-solid fa-circle-exclamation"></i> {errors.price}</p>}
              <input className={`${errors.quantity ? "update-modal-error" : ""}`} value={quantity} onChange={(e) => setQuantity(e.target.value)}></input>
              {errors.quantity && <p className="create-part-modal-error-quantity"><i className="fa-solid fa-circle-exclamation"></i> {errors.quantity}</p>}
              <select
              ...
              {errors.status && <p className="create-part-modal-error-status"><i className="fa-solid fa-circle-exclamation"></i> {errors.status}</p>}
